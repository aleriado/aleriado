...
* 🌱 **Active Contributed** to the [**Qbond**](https://github.com/aleriado/qbond-dashboard) on Qubic and [**NexiFuse**](https://nexifuse.com) in Midnight, focusing on smart contracts, protocol logic, frontend integration like [**NFT platform**](https://mkc1.onrender.com/) and  [**Qbond Dashboard**](https://qbond.org) in **Most Recently**.
